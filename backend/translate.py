...
def translateFunction(
    ...
    # local <
    graph: list = jsonLoad(pFile = f'{gDirectory}/backend/template/graph.json')
    neighbor: dict = jsonLoad(pFile = f'{gDirectory}/backend/template/neighbor.json')
    ...
    f3 = lambda l : {i : l.count(i) for i in graph}
